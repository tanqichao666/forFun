package com.tan.forfun.component;
...
@Aspect
@Component
public class RequsetLogAop {
	
	//ThreadLocal保证不受其他线程影响，用于记录接口响应时间
    private static ThreadLocal<Long> threadLocal = new ThreadLocal<Long>();
    
    private Logger logger = LoggerFactory.getLogger(RequsetLogAop.class);
    
    //切点， 每一个controller请求方法
    @Pointcut("execution(public * com.tan.forfun.controller..*.*(..))")
